...
- Turborepo monorepo at `consentchain/` (see upstream repo)
...
# See ../../04-consentchain/REGISTRY_PATH_MIGRATION.md for registry path proof table.
pnpm install
...
`/Users/coreyalejandro/Projects/the-living-constitution/projects/consentchain/` (see `04-consentchain/REGISTRY_PATH_MIGRATION.md`)
