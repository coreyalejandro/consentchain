...
exports.ConstitutionalValidator = exports.DEFAULT_PRINCIPLES = exports.PROACTIVE_INVARIANTS = void 0;
/**
 * The six non-negotiable invariants from PROACTIVE Constitution
 */
exports.PROACTIVE_INVARIANTS = {
    I1: {
...
class ConstitutionalValidator {
    ...
    constructor(principles) {
        ...
        this.principles = principles ?? exports.DEFAULT_PRINCIPLES;
    }
    /**
     * Assess an intention against all PROACTIVE invariants
     */
    async assess(intention) {
    ...
    validateI1(claim) {
        ...
        return {
            invariant: exports.PROACTIVE_INVARIANTS.I1.name,
            code: 'I1',
            ...
            missing,
            suggestedAction: missing.length > 0 ? 'Add missing elements before output can proceed' : undefined,
        };
    }
    /**
     * Validate against I2 (No Phantom Work)
     */
    validateI2(claim, artifactExists) {
        ...
        const claimsExecution = executionPatterns.some((pattern) => claim.text.toLowerCase().includes(pattern));
        if (claimsExecution && !artifactExists) {
            return {
                invariant: exports.PROACTIVE_INVARIANTS.I2.name,
                code: 'I2',
                passed: false,
     ...
     */
    validateI3(claim, hasVerificationArtifacts) {
        ...
        const claimsHighConfidence = highConfidencePatterns.some((pattern) => claim.text.toLowerCase().includes(pattern));
        if (claimsHighConfidence && !hasVerificationArtifacts) {
            return {
                invariant: exports.PROACTIVE_INVARIANTS.I3.name,
                code: 'I3',
                passed: false,
     ...
     */
    validateI4(hasTraceLinks) {
        if (!hasTraceLinks) {
            return {
                invariant: exports.PROACTIVE_INVARIANTS.I4.name,
                code: 'I4',
                passed: false,
     ...
     */
    generateFailClosedOutput(failedChecks) {
     ...
     */
    async runAllChecks(intention) {
        const checks = [];
        // Map intention to PROACTIVE invariant checks
        Object.entries(exports.PROACTIVE_INVARIANTS).forEach(([code, invariant]) => {
            const passed = this.checkInvariantForIntention(intention, code);
            checks.push({
     ...
     */
    checkInvariantForIntention(intention, code) {
        ...
        switch (code) {
            ...
            case 'I2':
                ...
                return !(content.includes('created') ||
     ...
     */
    getInvariants() {
        return exports.PROACTIVE_INVARIANTS;
    }
    /**
     ...
     */
    async incorporateLearning(signals) {
...
exports.ConstitutionalValidator = ConstitutionalValidator;
