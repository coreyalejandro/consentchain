...
> Ready-to-paste content for LinkedIn headline, about, experience, and skills.
> Uses canonical language from `01-identity/identity-language.md`.
> Claims bounded by `09-status/implementation-status-matrix.md`.
> Optimized for: Safety Systems Design identity, Coursera instructor applications, IBM Skills Mastery Platform applications.
...
My work spans four safety domains:

-- Epistemic Safety — preventing false claims, hallucinated outputs, and phantom completions in AI systems. PROACTIVE is a constitutional AI safety agent validated at n=200 with 100% detection rate and 0% false positives.
...
### Safety Systems Designer (Current)
- Designed and validated PROACTIVE — constitutional AI safety agent with 100% detection rate on n=200 TruthfulQA samples
- Building UICare-System — loop detection and rescue system for neurodivergent-friendly development
- Architecting ConsentChain — cryptographic consent ledger for AI agent governance (Turborepo, 8 packages)
...
- This arc is the foundation of Cognitive Safety — the same discipline applied to AI-era learning
...
## Skills (Optimized for Safety Engineering + Instructional Design)
...
- Course Development (LMS platforms)
...
### Platform-Specific Skills (for discoverability)
- Coursera Course Development
- IBM Skills Network
- Learning Management Systems
- ADDIE / SAM Instructional Models

## Coursera / IBM Skills Mastery Application Notes
...
5. **Accessibility-first**: UICare's neurodivergent-friendly design philosophy extends to course design
6. **Doctrine applies to learning**: "No failure is meaningless" means every learner misunderstanding is a signal about the instructional system, not the learner
